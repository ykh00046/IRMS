...
1. 관리자가 배포한 `IRMS-Notice-Setup-3.1.1.exe` 더블클릭
...
- `tray_client\build\Output\IRMS-Notice-Setup-3.1.1.exe` — **배포용 설치 파일**

### 2.2 현장 PC 7대 설치

1. `IRMS-Notice-Setup-3.1.1.exe`를 USB / 공유 폴더로 복사
