...
def build_router(templates: Jinja2Templates) -> APIRouter:
    ...
    def attendance_login_page(request: Request) -> Response:
    ...
    def attendance_change_password_page(request: Request) -> Response:
        emp_id = current_attendance_emp_id(request)
        if not emp_id:
            return RedirectResponse(url="/attendance/login", status_code=303)
    ...
    def work_page_alias(request: Request) -> Response:
